...
-- 44: Team
-- 66: Ping
local bountyL = label(0)
local fpsL = label(22)
local teamL = label(44)
local pingL = label(66)
...
RunService.RenderStepped:Connect(function()
    -- BOUNTY
    pcall(function()
        if player.leaderstats and player.leaderstats:FindFirstChild("Bounty/Honor") then
            bountyL.Text = "Bounty: "..player.leaderstats["Bounty/Honor"].Value
        else
            bountyL.Text = "Bounty: N/A"
        end
    end)
    ...
    pcall(function()
        if player.Team then
            teamL.Text = "Team: "..player.Team.Name
        else
            teamL.Text = "Team: N/A"
        end
    end)
    ...
    pcall(function()
        ...
        pingL.Text = "Ping: "..math.floor(ping).." ms"
    end)
end)
